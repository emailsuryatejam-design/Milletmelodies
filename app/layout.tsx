          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              address: {
                ...
                addressLocality: 'Bachupally, Hyderabad',
              ...
              sameAs: [
                'https://instagram.com/nellai_thatibellam_coffee',
                'https://facebook.com/milletmillodies',
                'https://share.google/QG96SxToYcXfVqQxI',
              ],
              hasMenu: {
                '@type': 'Menu',
                name: 'Breakfast Menu',
            ...
            __html: JSON.stringify({
              ...
              mainEntity: [
                ...
                },
                {
                  ...
                  acceptedAnswer: {
                    '@type': 'Answer',
                    text: 'We are open from 6:00 AM to 11:00 PM on weekdays (Mon–Fri) and 6:00 AM to 12:00 AM (midnight) on weekends (Sat–Sun).',
                  },
                },
              ],
            }),
